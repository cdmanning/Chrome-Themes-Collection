...
1. In the [Live Preview](), click the **"Available in Chrome Web Store"** button.
...
1. **Download:** Navigate to the [**Releases**](https://github.com/YOUR_USERNAME/YOUR_REPO/releases) page and download the `.zip` file for your chosen theme.
